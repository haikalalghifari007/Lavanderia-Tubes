      ...
      <div class="card-body">
        <div class="row d-flex justify-content-center pb-5">
          <div class="col-md-7 col-xl-5 mb-4 mb-md-0">
            ...
            <h4 style="color:#30CD4A;">Bronze Pass</h4>
            <div class="d-flex pt-2">
              <div>
                <p>
                  <b>Pengaktifan member Lavanderia </b>
                </p>
              </div>
            </div>
            <p>
              Anda memilih paket member " Bronze pass " selamat menikmati keuntungan sebagai membership selama 1 minggu.
            </p>
            ...
            <div class="pt-2">
              <div class="d-flex pb-2">
                <div>
                  <p>
                    <b>Total Pembayaran <span class="text-success">Rp 85.000</span></b>
                  </p>
                </div>
                <div class="ms-auto">
          ...
          <div class="col-md-5 col-xl-4 offset-xl-1">
            ...
            <div class="rounded d-flex flex-column p-2" style="background-color: #f8f9fa;">
              ...
              <div class="p-2 d-flex">
                <div class="col-8">Bronze Pass</div>
                <div class="ms-auto">Rp 85.000</div>
              </div>
              ...
              <div class="p-2 d-flex pt-3">
                ...
                <div class="ms-auto"><b class="text-success">Rp 85.000</b></div>
              </div>
            </div>
          </div>
        </div>
